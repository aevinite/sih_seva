...
export default function AeviniteConsole() {
  ...
  const nav: NavItem[] = [
    ...
    { view: "verifications", en: "Verifications", hi: "सत्यापन", title: "Verification Queue", icon: <NavIcon d={<><path d="M12 3.5 4.7 6.9v5.6c0 4.8 3.2 7.9 7.3 9.9 4.1-2 7.3-5.1 7.3-9.9V6.9z" /><path d="M8.5 13.3l2.6 2.6 4.7-5.2" /></>} /> },
          ...
          <Link href="/" className="brand">
            <span className="brand-mark">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 3.5 4.7 6.9v5.6c0 4.8 3.2 7.9 7.3 9.9 4.1-2 7.3-5.1 7.3-9.9V6.9z" /><path d="M8.5 13.3l2.6 2.6 4.7-5.2" />
              </svg>
            </span>
  ...
  return (
    <View name="verifications">
      <div className="card ai-card panel mb-3">
        <div className="row-top"><span className="ai-badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 3.5 4.7 6.9v5.6c0 4.8 3.2 7.9 7.3 9.9 4.1-2 7.3-5.1 7.3-9.9V6.9z" /></svg> KYC Queue</span></div>
