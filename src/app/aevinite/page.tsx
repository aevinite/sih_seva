...
export default function AeviniteConsole() {
  ...
  const nav: NavItem[] = [
    ...
    { view: "verifications", en: "Verifications", hi: "सत्यापन", title: "Verification Queue", icon: <NavIcon d={<><path d="M12 4.3 5.2 7.3v5.1c0 4.4 3 7.2 6.8 8.8 3.8-1.6 6.8-4.4 6.8-8.8V7.3z" /><path d="M8.8 12.7l2.4 2.4 4.2-4.7" /></>} /> },
          ...
          <Link href="/" className="brand">
            <span className="brand-mark">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 4.3 5.2 7.3v5.1c0 4.4 3 7.2 6.8 8.8 3.8-1.6 6.8-4.4 6.8-8.8V7.3z" /><path d="M8.8 12.7l2.4 2.4 4.2-4.7" />
              </svg>
            </span>
  ...
  return (
    <View name="verifications">
      <div className="card ai-card panel mb-3">
        <div className="row-top"><span className="ai-badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 4.3 5.2 7.3v5.1c0 4.4 3 7.2 6.8 8.8 3.8-1.6 6.8-4.4 6.8-8.8V7.3z" /></svg> KYC Queue</span></div>
